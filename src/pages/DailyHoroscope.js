    ...
    <div>
      ...
      <div className="cust-topbar">
        <div className="cust-topbar-left">
          ...
          <div>
            <h2 className="cust-title">Daily Horoscope</h2>
            <div className="cust-count">{totalRecords} total</div>
          </div>
        </div>
        <div className="cust-topbar-right">
          <button onClick={handleGenerate} disabled={generating} className="cust-btn cust-btn-success" style={{ opacity: generating ? 0.6 : 1 }}>
            <Star size={15} /> {generating ? 'Generating...' : 'Generate Today'}
          </button>
        </div>
      </div>
      ...
      <div className="cust-card">
        {loading ? <Loader text="Loading daily horoscopes..." /> : (
